...
stopLossMargin = 0.01 # percentage margin for the stop stop loss
...
# LIMIT PRICES
maxVar = 0.02 # max variation % when buying or selling

# MAX ATTEMPTS SECTION
maxAttemptsCP = 10 # CHECK POSITION
maxAttemptsGCP = 5 # GET CURRENT PRICE
maxAttemptsGGT = 10 # GET GENERAL TREND
maxAttemptsGIT = 10 # GET INSTANT TREND
maxAttemptsRSI = 10 # GET RSI TREND
maxAttemptsSTC = 10 # GET STOCHASTIC
...
sleepTimeRSI = 20 # GET RSI TREND
sleepTimeSTC = 10 # GET STOCHASTIC
